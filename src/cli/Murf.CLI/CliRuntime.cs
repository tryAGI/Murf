...
{
    private const string UserSecretsId = "Murf.CLI";
    private const string UserSecretApiKeyName = "MURF_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"MURF_API_KEY"];
    private const string CredentialFileDirectoryName = ".murf";

    public static async global::System.Threading.Tasks.Task<global::Murf.MurfClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Murf.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Murf.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Murf.MurfClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Murf.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Murf.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Murf.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Murf.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("MURF_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Murf.ApiException exception)
    {
        var builder = new StringBuilder();

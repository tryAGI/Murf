...
internal static class CliRuntime
{
    ...
    public static async Task<global::Murf.MurfClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Murf.ApiException exception)
    {
        var builder = new StringBuilder();

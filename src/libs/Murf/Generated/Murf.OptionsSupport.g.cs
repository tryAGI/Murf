...
namespace Murf
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Murf.AutoSDKRetryOptions Retry { get; set; } = new global::Murf.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Murf.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Murf.IAutoSDKHook>();
        ...
        public global::Murf.AutoSDKClientOptions AddHook(
            global::Murf.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Murf.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Murf.AutoSDKClientOptions UseAuthorizationProvider(
            global::Murf.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Murf.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Murf.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Murf.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Murf.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Murf.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Murf.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Murf.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Murf.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Murf.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Murf.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Murf.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Murf.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Murf.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Murf.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Murf.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Murf.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Murf.AutoSDKClientOptions clientOptions,
            global::Murf.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Murf.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Murf.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Murf.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Murf.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Murf.IAutoSDKHook, global::Murf.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Murf.AutoSDKHookContext context)
        {

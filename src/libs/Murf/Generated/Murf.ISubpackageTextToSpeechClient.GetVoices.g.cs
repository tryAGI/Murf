...
namespace Murf
{
    public partial interface ISubpackageTextToSpeechClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Murf.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Murf.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Murf.ApiVoice>>> GetVoicesAsResponseAsync(
            string? model = default,
            string? token = default,
            global::Murf.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);

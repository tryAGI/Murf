...
namespace Murf
{
    public partial interface ISubpackageDubbingSubpackageDubbingLanguagesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Murf.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Murf.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Murf.LocaleResponse>>> ListDestinationLanguagesAsResponseAsync(
            global::Murf.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}